...
TEST_CASE("DoF Transformation Functions Curl",
          "[DofTransformation]"
          "[TransformPrimal]"
          "[TransformDual]")
{
   ...
   CURL_PentDofTransformation Tndp(p);
   CURL_PentDofTransformation Tndq(q);
...
TEST_CASE("DoF Transformation Classes 4D",
          "[DofTransformation]"
          "[ND_TetDofTransformation]")
{
    int p = 3;
    ...
    SECTION("SkwGrad Pentatope Transformations")
    {
       ND_PentDofTransformation Tnd(p);
       ...
       SECTION("VDim == 1")
       {
          ...
          T.SetPlanarOrientations(ori_pl);
          T.SetFaceOrientations(ori_ft);
...
TEST_CASE("DoF Transformation Classes Curl-4D",
          "[DofTransformation]"
          "[Curl_TetDofTransformation]")
{
    int p = 2;
    int vdim = 4;
    int seed = 123;
    ...
    SECTION("SkwGrad Pentatope Transformations")
    {
       CURL_PentDofTransformation Tnd(p);

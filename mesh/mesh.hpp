...
public:
   ...
   */
   ...
   /// 8 vertices @a vi.
   /// Adds a pentatope to the mesh given by 5 vertices @a v1 through @a v5.
   int AddPent(int v1, int v2, int v3, int v4, int v5, int attr = 1);
   ...
   int AddBdrTet(int v1, int v2, int v3, int v4, int attr = 1);
   ...
   */
   ...
   void GetPlanarVertices(int i, Array<int> &vert) const;
